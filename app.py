...
with ui.sidebar():
    # Add a slider to specify the number of bins in the histogram.
    ...
    # 2. A string label ("Number of Bins") will be displayed alongside the slider.
...
def draw_histogram():
    ...
    # - Each sample is t hen scaled by 15 (to increase the spread) and shifted by 100 to (to center the distribution around 100).
